...
<Link className='mt-auto' to={`product/${id}`} ><button className='py-3 bg-orange-400 w-full text-slate-900 hover:bg-orange-500 duration-150 font-semibold'>See More</button></Link>
